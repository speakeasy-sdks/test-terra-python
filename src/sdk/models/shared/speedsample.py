...
class SpeedSample:
    ...
    speed_meters_per_second: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('speed_meters_per_second'), 'exclude': lambda f: f is None }})
    r"""User's speed at a given instant in time"""  
