...
class PositionSample:
    ...
    coords_lat_lng_deg: Optional[list[float]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('coords_lat_lng_deg'), 'exclude': lambda f: f is None }})
    r"""Position of the user a given point in time, represented by a 2-value array of latitude, longitude, wherein each of the two numbers can be nullable"""  
