...
class PowerSample:
    ...
    watts: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('watts'), 'exclude': lambda f: f is None }})
    r"""Power generated at a given instant in time"""  
