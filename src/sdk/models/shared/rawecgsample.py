...
class RawECGSample:
    ...
    potential_u_v: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('potential_uV'), 'exclude': lambda f: f is None }})
    r"""Potential uV in the RawECG Sample"""  
