...
from ..shared import drinksample as shared_drinksample
from ..shared import meal as shared_meal
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class NutritionSummaryMacros:
    r"""Summary of macronutrient information for a given day"""
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class NutritionSummaryMicros:
    r"""Summary of micronutrient information for a given day"""
...
class NutritionSummary:
    r"""Summative nutritional information for a given day"""
    
    macros: Optional[NutritionSummaryMacros] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('macros'), 'exclude': lambda f: f is None }})
    r"""Summary of macronutrient information for a given day"""  
    micros: Optional[NutritionSummaryMicros] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('micros'), 'exclude': lambda f: f is None }})
    r"""Summary of micronutrient information for a given day"""  
    water_ml: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('water_ml'), 'exclude': lambda f: f is None }})
    r"""Water consumption of the user for a given day"""  
...
class Nutrition:
    ...
    drink_samples: Optional[list[shared_drinksample.DrinkSample]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('drink_samples'), 'exclude': lambda f: f is None }})
    r"""Information on drinks the user consumed throughout the day"""  
    meals: Optional[list[shared_meal.Meal]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meals'), 'exclude': lambda f: f is None }})
    r"""Information on individual foods consumed throughout a given day"""  
    metadata: Optional[NutritionMetadata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadata'), 'exclude': lambda f: f is None }})
    r"""Object containing daily summary metadata"""  
    summary: Optional[NutritionSummary] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('summary'), 'exclude': lambda f: f is None }})
    r"""Summative nutritional information for a given day"""  
