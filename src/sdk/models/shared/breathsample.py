...
class BreathSample:
    ...
    breaths_per_min: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('breaths_per_min'), 'exclude': lambda f: f is None }})
    r"""User's respiration rate"""  
