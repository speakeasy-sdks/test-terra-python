...
class HeartRateVariabilityDataSampleRMSSD:
    
    hrv_rmssd: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('hrv_rmssd'), 'exclude': lambda f: f is None }})
    r"""User's Heart Rate Variability, computed using RMSSD"""  
