...
class ElevationSample:
    ...
    elev_meters: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('elev_meters'), 'exclude': lambda f: f is None }})
    r"""User's altitude at a given point in time"""  
