...
class CadenceSample:
    ...
    cadence_rpm: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence_rpm'), 'exclude': lambda f: f is None }})
    r"""Cadence of the user at a given instant in time - only relevant to cycling"""  
