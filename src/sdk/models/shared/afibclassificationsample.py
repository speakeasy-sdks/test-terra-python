...
class AFibClassificationSample:
    
    afib_classification: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('afib_classification'), 'exclude': lambda f: f is None }})
    r"""Flag indicating the atrial fibrillation classification of the individual"""  
