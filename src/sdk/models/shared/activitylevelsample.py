...
class ActivityLevelSampleActivityLevelEnum(str, Enum):
    r"""Intensity of the user's activity at an instant in time"""
    UNKNOWN = 'UNKNOWN'
    REST = 'REST'
    INACTIVE = 'INACTIVE'
...
class ActivityLevelSample:
    ...
    activity_level: Optional[ActivityLevelSampleActivityLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('activity_level'), 'exclude': lambda f: f is None }})
    r"""Intensity of the user's activity at an instant in time"""  
