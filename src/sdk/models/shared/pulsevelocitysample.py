...
class PulseVelocitySample:
    
    pulse_wave_velocity_meters_per_second: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pulse_wave_velocity_meters_per_second'), 'exclude': lambda f: f is None }})
    r"""User's Pulse Wave Velocity measurement -  velocity at which the blood pressure pulse propagates through the circulatory system"""  
