...
class PostBodyRequestBody:
    
    data: list[shared_body.Body] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
    r"""Body measurement metrics to post to data provider"""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostBody404ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostBody403ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostBody400ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostBody201ApplicationJSON:
...
class PostBodyResponse:
    ...
    post_body_201_application_json_object: Optional[PostBody201ApplicationJSON] = dataclasses.field(default=None)
    r"""Returned when activity was successfully created on the provider"""  
    post_body_400_application_json_object: Optional[PostBody400ApplicationJSON] = dataclasses.field(default=None)
    r"""Returned when one or more parameters is malformed - an appropriate error message will be returned"""  
    post_body_403_application_json_object: Optional[PostBody403ApplicationJSON] = dataclasses.field(default=None)
    r"""Returned when credentials (dev ID and API key) are invalid"""  
    post_body_404_application_json_object: Optional[PostBody404ApplicationJSON] = dataclasses.field(default=None)
    r"""Returned when a parameter does not exist on Terra's end (e.g. user_id)"""  
