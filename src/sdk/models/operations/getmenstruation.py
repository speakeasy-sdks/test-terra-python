...
from ..shared import menstruation as shared_menstruation
...
@dataclasses.dataclass
class GetMenstruation404ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetMenstruation403ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetMenstruation401ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetMenstruation400ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetMenstruation200ApplicationJSON1:
    
    data: Optional[list[shared_menstruation.Menstruation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
...
class GetMenstruationResponse:
    ...
    get_menstruation_200_application_json_one_of: Optional[Any] = dataclasses.field(default=None)
    r"""Returned upon successful data request"""  
    get_menstruation_400_application_json_object: Optional[GetMenstruation400ApplicationJSON] = dataclasses.field(default=None)
    r"""Returned when one or more parameters is malformed - an appropriate error message will be returned"""  
    get_menstruation_401_application_json_object: Optional[GetMenstruation401ApplicationJSON] = dataclasses.field(default=None)
    r"""Returned when authorization with a data provider has failed"""  
    get_menstruation_403_application_json_object: Optional[GetMenstruation403ApplicationJSON] = dataclasses.field(default=None)
    r"""Returned when credentials (dev ID and API key) are invalid"""  
    get_menstruation_404_application_json_object: Optional[GetMenstruation404ApplicationJSON] = dataclasses.field(default=None)
    r"""Returned when a parameter does not exist on Terra's end (e.g. user_id)"""  
